...
- **Valeur actuelle** : **195.12 €** (-2.44 %) — _book 9,756 $_
- **Drawdown max** : 2.77 %
- **Jours écoulés** : 18.5
- **Dernier point** : 2026-07-21T04:54:34+00:00
...
▇▇▇▇▇▇▇▇▆▆█▇▇▇▇▇▇▇▇▆▆▅▅▆▇▇▇▇▅▅▄▃▃▂▂▂▂▂▁▁▁▁▁▁▁▁▁▁
```
min 9,756 $ — max 10,034 $

## Métriques

| Métrique | Valeur |
|---|---|
| Trades (open + close, exécutés ou dry-run) | 39 |
...
| Ratio gain/perte | — |
| Espérance par trade | — |
| Coûts bruts estimés (proxy spread 0,1 %) | 18.30 $ |
