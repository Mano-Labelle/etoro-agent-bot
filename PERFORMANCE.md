...
- **Valeur actuelle** : **194.00 €** (-3.00 %) — _book 9,700 $_
- **Drawdown max** : 3.50 %
- **Jours écoulés** : 32.6
- **Dernier point** : 2026-08-04T08:12:33+00:00
...
| Métrique | Valeur |
|---|---|
| Trades (open + close, exécutés ou dry-run) | 58 |
...
| Ratio gain/perte | — |
| Espérance par trade | — |
| Coûts bruts estimés (proxy spread 0,1 %) | 24.98 $ |
